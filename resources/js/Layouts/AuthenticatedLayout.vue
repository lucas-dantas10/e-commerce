                    ...
                    <div class="flex justify-between h-16">
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            <a :href="route('carrinho.index')" class="relative w-[7.5rem] inline-flex items-center gap-2 px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 cursor-pointer focus:outline-none transition ease-in-out duration-150">
                                ...
                                <p>Carrinho</p>
                                <div v-if="quantityCartItems != 0" class="absolute right-0 top-0 rounded-full border border-red-500 py-[2px] px-[8px] bg-red-500 text-white">
                                    {{ quantityCartItems }}
                                </div>
                            </a>
                            <a 
                                ...
                                :href="route('login')" 
                                class="inline-flex items-center gap-2 px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 cursor-pointer focus:outline-none transition ease-in-out duration-150"
                            >
                                <v-icon name="hi-login"></v-icon>
                                <p>Login</p>
                            </a>
                            <a 
                                v-if="!$page.props.auth.user"
